...
const RightPanel = () => {
  ...
  return (
    <div className='w-full lg:w-80 h-full overflow-y-auto bg-white p-6 rounded-2xl'>
      {/* Statistic Card */}
      <div className='mb-8'>
          ...
          <div className='text-center mb-6'>
            <div className='relative inline-block'>
              <div className='w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mb-3'>
                <img src="https://www.tapback.co/api/avatar/johndoe" alt="User Avatar" className='w-16 h-16 rounded-full' />
              </div>
            ...
            <div className='mb-4'>
              ...
              <p className='text-sm text-gray-600'>
                Conningency rewarding to achieve your target
              </p>
            </div>
          </div>
